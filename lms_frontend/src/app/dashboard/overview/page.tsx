 ...
 * Generic dashboard for users with unknown roles or as fallback
 */
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <p className="text-gray-600">
          If you believe this is incorrect, please contact your system administrator to update your role and permissions.
        </p>
      </div>
    </div>
  );
